...
public class FileController {
    ...
    public ResponseEntity<InputStreamResource> showFile(@RequestParam(value = "fileId") Long fileId){

        InputStreamResource inputStreamResource = attachedFileService.findFile(fileId);
